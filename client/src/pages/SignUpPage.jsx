      ...
      <div className="card w-full max-w-md shadow-2xl bg-white">
        <div className="card-body p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className={`w-full py-3 px-4 bg-gray-800 text-amber-300 font-bold rounded-full hover:bg-gray-700 transition duration-200 ${
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center px-4 py-2 border border-gray-300 rounded-full text-gray-700 hover:bg-gray-50 transition duration-200">
              <svg
                xmlns="http://www.w3.org/2000/svg"
